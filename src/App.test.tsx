...
describe('App', () => {
  test('renders home page by default', () => {
    ...
    const homePageElement = screen.getByText(/Welcome to Getsafe's Insurance Services/i);
  ...
  test('navigates to developer insurance page', () => {
    ...
    const developerInsurancePageElement = screen.getByText(/Buying developer insurance/i);
  ...
  test('navigates to designer insurance page', () => {
    ...
    const designerInsurancePageElement = screen.getByText(/Buying designer insurance/i);
